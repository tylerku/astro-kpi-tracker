...
export default async function GET(
	...
	response: NextApiResponse,
		...
		const kpis = await notionService.getTodaysKPIs(['Agent Conversations'], {})
		...
		const updatedKpi = await notionService.updateTodaysKPI('Agent Conversations', kpiToUpdate.value + 1)
		/* 
